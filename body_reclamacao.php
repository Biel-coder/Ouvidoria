...
<body class="body">
    <a href="ouvidoria.php">
        <div class="text-center">
         ...
         <form method="POST" action="valida_reclamacao.php">
  
  <div class="text-center">
      <img src="Reclamacao.jpg" class="rounded" alt="Reclamação"><br><br><br>
    <h4 class="cor"><strong>Qual o seu nível de insatisfação com os serviços prestados pela Solar Cuidados?</strong></h4>
    <div class="form-check cor">
      <input class="form-check-input" type="radio" name="satisfacao" value="Insatisfeito" required>
      <label class="form-check-label" for="exampleRadios2">
       <p class="cor">Insatisfeito</p>
      </label>
    </div>
    <div class="form-check cor">
      <input class="form-check-input" type="radio" name="satisfacao" value="Muito insatisfeito" required>
      <label class="form-check-label" for="exampleRadios3">
        <p class="cor">Muito insatisfeito</p>
      </label>
    </div>
    ...
    <hr>
        ...
        <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" name="nota" required>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h3 class="text-center cor"><strong>Manifeste aqui a sua reclamação.</strong></h3>
                <h3 class="text-center cor"><strong>(Sinalize o setor)</strong></h3>
            </div>
            <div class="card-body">
                <link rel="stylesheet" href="css/bootstrap.min.css">
                    
                        <textarea name="reclamacao" placeholder="Escreva aqui..." class="form-control" cols="30" rows="10" required></textarea>
